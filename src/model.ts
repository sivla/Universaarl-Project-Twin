...
export const setupWaveProjectionSchema = z.object({
  ...
  configurationState: z.object({
    baselineKind: z.literal('standard-cronus-demo'), baselineProvenance: z.literal('microsoft-standard-cronus-demo-data'), pilotConfigured: z.literal(false), writesApplied: z.literal(false), readbackStatus: z.literal('pending'),
