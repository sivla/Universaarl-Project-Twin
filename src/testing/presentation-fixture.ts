...
export const artifactViewerFixtureResources = [
  { id: `rs_${'1'.repeat(24)}`, artifactId: 'UABC-RES-GUIDE-001', title: 'Klickanleitung Buchungsprüfung', artifactType: 'click-guide', mediaType: 'text/markdown', sizeBytes: 74, sha256: 'a'.repeat(64), status: 'Validiert', createdAt: null, actorRef: null, jiraRefs: ['UABC-16'], confluenceRefs: ['DOC-PROJECT-PROCESS'], deliverableRefs: [], caption: null, processStep: 'Gebuchte Rechnung prüfen', precondition: 'Synthetischer Beleg ist vorhanden.', postcondition: 'Kontrolle ist dokumentiert.', previewMode: 'markdown', downloadable: true },
  { id: `rs_${'2'.repeat(24)}`, artifactId: 'UABC-RES-SHOT-001', title: 'Screenshot des Retests', artifactType: 'screenshot', mediaType: 'image/png', sizeBytes: 68, sha256: 'b'.repeat(64), status: 'Validiert', createdAt: null, actorRef: null, jiraRefs: ['UABC-16'], confluenceRefs: [], deliverableRefs: [], caption: 'Erfolgreiche Kontrolle nach der Korrektur', processStep: 'Retest', precondition: null, postcondition: 'Ergebnis ist grün.', previewMode: 'image', downloadable: true },
  { id: `rs_${'3'.repeat(24)}`, artifactId: 'UABC-RES-PDF-001', title: 'Abnahmeprotokoll', artifactType: 'deliverable', mediaType: 'application/pdf', sizeBytes: 38, sha256: 'c'.repeat(64), status: 'Validiert', createdAt: null, actorRef: null, jiraRefs: [], confluenceRefs: [], deliverableRefs: ['UABC-DEL-001'], caption: null, processStep: null, precondition: null, postcondition: null, previewMode: 'pdf', downloadable: true },
  { id: `rs_${'4'.repeat(24)}`, artifactId: 'UABC-RES-DOCX-001', title: 'Schulungsunterlage', artifactType: 'training', mediaType: 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', sizeBytes: 6, sha256: 'd'.repeat(64), status: 'Validiert', createdAt: null, actorRef: null, jiraRefs: [], confluenceRefs: ['DOC-PROJECT-PROCESS'], deliverableRefs: [], caption: null, processStep: null, precondition: null, postcondition: null, previewMode: 'download', downloadable: true },
] as const;
...
export const presentationFixtureState: ProjectState = projectStateSchema.parse({
  ...
  artifacts: fixtureArtifacts, evidenceItems: [], resources: artifactViewerFixtureResources, documents: fixtureDocuments,
