...
function phase(id: string, startDate: string | null, dueDate: string | null): Artifact {
  return artifactSchema.parse({ id, kind: 'document', title: `Phase ${id}`, sourceType: 'project-plan', phaseId: id, startDate, dueDate, sourcePath: 'project/bc-basic/project-plan.yaml' });
}
...
describe('Gantt-Projektion des commitgebundenen Projektplans', () => {
  it('ordnet belegte Phasen deterministisch auf einer gemeinsamen Zeitachse an', () => {
    const projection = buildGanttProjection([phase('UABC-PHASE-02', '2026-08-24', '2026-08-28'), phase('UABC-PHASE-01', '2026-08-03', '2026-08-21'), phase('UABC-PHASE-03', '2026-08-31', '2026-09-04')]);
