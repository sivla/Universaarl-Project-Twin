...
describe('fachlicher aktueller Projektstand', () => {
  ...
  it('hält technische Kanalangaben und Rohdetailöffnungen aus der Managementsicht', () => {
    ...
    expect(overviewSource).toContain('Aktueller Scope');
    expect(overviewSource).toContain('AKTUELLER FOKUS');
    expect(overviewSource).toContain('STEUERUNGSBEDARF');
    expect(overviewSource).toContain('NÄCHSTE HANDLUNG');
    expect(overviewSource).toContain('Budgetstatus');
    expect(overviewSource).toContain('blockierte Vorgänge');
    ...
    expect(overviewSource).toContain('overview-kpis');
    expect(overviewSource).toContain('pm-command-grid');
    ...
    expect(ui).toContain('CORE-FINANCE-Vorbereitung');
    expect(ui).toContain('Paketimport');
    expect(ui).toContain('Manuelle Einrichtung');
    expect(ui).toContain('Finanzstruktur');
    expect(ui).toContain('In BC angewendet');
    expect(ui).toContain('Kundenseitig abgenommen');
